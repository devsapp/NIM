...
- :fire: 通过 [云原生应用开发平台 CAP](https://cap.console.aliyun.com/template-detail?template=cap-nim-asr) ，[![Deploy with Severless Devs](https://img.alicdn.com/imgextra/i1/O1CN01w5RFbX1v45s8TIXPz_!!6000000006118-55-tps-95-28.svg)](https://cap.console.aliyun.com/template-detail?template=cap-nim-asr) 该应用。
...
本应用旨在帮助开发者实现将NVIDIA NIM ASR 应用部署到阿里云函数计算，并且轻松实现一键拉起 NVIDIA NIM 驱动的 ASR demo，体验语音实时转化为文字
...
![](https://img.alicdn.com/imgextra/i4/O1CN0191SyJk1R2mZ8TfPCI_!!6000000002054-2-tps-980-518.png)
...
**步骤一**：登录阿里云云应用开发平台 CAP 控制台，点击左侧「探索」，在「人工智能」页签下找到 NIM ASR 应用，点击并「立即部署」 ![](https://img.alicdn.com/imgextra/i3/O1CN01oCiiwP1dmNNnYUUfW_!!6000000003778-0-tps-456-222.jpg)


**步骤二**：填入 API_KEY，并点解部署项目 ![](https://img.alicdn.com/imgextra/i4/O1CN01sQLy3c1T4H5XbQNA7_!!6000000002328-0-tps-1644-1204.jpg)


**步骤三**：耐心等待，显示部署成功后，点击名为 `TTS` 的 Web 服务，点击访问地址，即可访问应用开始体验 NIM ASR 
![](https://img.alicdn.com/imgextra/i4/O1CN01YHVAU21mllOZmSwAG_!!6000000004995-0-tps-2220-622.jpg)
![](https://img.alicdn.com/imgextra/i2/O1CN01FtfPvB1vMsPs2XqEb_!!6000000006159-0-tps-2560-1318.jpg)
